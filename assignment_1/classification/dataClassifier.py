...
def enhancedFeatureExtractorDigit(datum):
    ...
    # for x in range(50-2):
    #     for y in range(50):
    #         features[0] += (getPixelVal(x,y) == 0 and getPixelVal(x+1,y) == 1 and getPixelVal(x+2,y) == 0)

    # for x in range(50):
    #     for y in range(50-2):
    #         features[1] += (getPixelVal(x,y) == 0 and getPixelVal(x,y+1) == 1 and getPixelVal(x,y+2) == 0)
